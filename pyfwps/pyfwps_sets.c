...
PySequenceMethods pyfwps_sets_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwps_sets_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwps_sets_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwps_sets_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwps.sets",
	/* tp_basicsize */
	sizeof( pyfwps_sets_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwps_sets_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	/* tp_doc */
	"pyfwps sequence and iterator object of sets",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwps_sets_iter,
	/* tp_iternext */
	(iternextfunc) pyfwps_sets_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
...
/* Creates a new sets sequence and iterator object
...
PyObject *pyfwps_sets_new(
           ...
           int number_of_items )
{
	pyfwps_sets_t *sequence_object = NULL;
	static char *function          = "pyfwps_sets_new";
	...
	/* Make sure the sets values are initialized
	 */
	sequence_object = PyObject_New(
	                   struct pyfwps_sets,
	                   &pyfwps_sets_type_object );
...
/* Initializes a sets sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyfwps_sets_init(
     pyfwps_sets_t *sequence_object )
{
	static char *function = "pyfwps_sets_init";
	...
	PyErr_Format(
	 ...
	 "%s: initialize of sets not supported.",
	 function );

	return( -1 );
}

/* Frees a sets sequence object
 */
void pyfwps_sets_free(
      pyfwps_sets_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfwps_sets_free";
...
/* The sets len() function
 */
Py_ssize_t pyfwps_sets_len(
            pyfwps_sets_t *sequence_object )
{
	static char *function = "pyfwps_sets_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function = "pyfwps_sets_getitem";
	...
	set_object = sequence_object->get_item_by_index(
...
/* The sets iter() function
 */
PyObject *pyfwps_sets_iter(
           pyfwps_sets_t *sequence_object )
{
	static char *function = "pyfwps_sets_iter";
...
/* The sets iternext() function
 */
PyObject *pyfwps_sets_iternext(
           pyfwps_sets_t *sequence_object )
{
	PyObject *set_object  = NULL;
	static char *function = "pyfwps_sets_iternext";
