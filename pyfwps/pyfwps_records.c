...
PySequenceMethods pyfwps_records_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfwps_records_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfwps_records_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfwps_records_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfwps.records",
	/* tp_basicsize */
	sizeof( pyfwps_records_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfwps_records_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfwps_records_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfwps sequence and iterator object of records",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfwps_records_iter,
	/* tp_iternext */
	(iternextfunc) pyfwps_records_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
...
PyObject *pyfwps_records_new(
           ...
           int number_of_items )
{
	pyfwps_records_t *sequence_object = NULL;
	static char *function             = "pyfwps_records_new";
	...
	sequence_object = PyObject_New(
	                   struct pyfwps_records,
	                   &pyfwps_records_type_object );
 ...
 */
int pyfwps_records_init(
     pyfwps_records_t *sequence_object )
{
	static char *function = "pyfwps_records_init";
 ...
 */
void pyfwps_records_free(
      pyfwps_records_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfwps_records_free";
 ...
 */
Py_ssize_t pyfwps_records_len(
            pyfwps_records_t *sequence_object )
{
	static char *function = "pyfwps_records_len";
 ...
 */
PyObject *pyfwps_records_getitem(
           pyfwps_records_t *sequence_object,
           Py_ssize_t item_index )
{
	PyObject *record_object = NULL;
	static char *function   = "pyfwps_records_getitem";
 ...
 */
PyObject *pyfwps_records_iter(
           pyfwps_records_t *sequence_object )
{
	static char *function = "pyfwps_records_iter";
 ...
 */
PyObject *pyfwps_records_iternext(
           pyfwps_records_t *sequence_object )
{
	PyObject *record_object = NULL;
	static char *function   = "pyfwps_records_iternext";
