...
/* Tests the libfwps_notify_set_verbose function
 * Returns 1 if successful or 0 if not
 */
int fwps_test_notify_set_verbose(
     void )
{
...
/* Tests the libfwps_notify_set_stream function
 * Returns 1 if successful or 0 if not
 */
int fwps_test_notify_set_stream(
     void )
{
	...
	/* Test regular cases
	 */
	result = libfwps_notify_set_stream(
	          NULL,
	          &error );
...
/* Tests the libfwps_notify_stream_open function
 * Returns 1 if successful or 0 if not
 */
int fwps_test_notify_stream_open(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
	...
	/* Test regular cases
	 */
	result = libfwps_notify_stream_open(
	          "notify_stream.log",
	          &error );
	...
	/* Clean up
	 */
	result = libfwps_notify_stream_close(
	          &error );
...
/* Tests the libfwps_notify_stream_close function
 * Returns 1 if successful or 0 if not
 */
int fwps_test_notify_stream_close(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	FWPS_TEST_RUN(
	 "libfwps_notify_set_verbose",
	 fwps_test_notify_set_verbose )

	FWPS_TEST_RUN(
	 "libfwps_notify_set_stream",
	 fwps_test_notify_set_stream )

	FWPS_TEST_RUN(
	 "libfwps_notify_stream_open",
	 fwps_test_notify_stream_open )

	FWPS_TEST_RUN(
	 "libfwps_notify_stream_close",
	 fwps_test_notify_stream_close )
